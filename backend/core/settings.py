...
TYPE_ENV = os.environ.get("TYPE_ENV")

BASE_DIR = Path(__file__).resolve().parent.parent

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-3hzm48)(5%ml-e_$h$t)j)=3@5(i3vjn#y(=kc%o-@lj#_z_0*' if TYPE_ENV == 'dev' else os.environ.get("DJANGO_SECRET_KEY")
...
DATABASES = {
    'default': {
        ...
        "PORT": '5432' if TYPE_ENV == 'dev' else os.environ.get("POSTGRES_PORT"),
